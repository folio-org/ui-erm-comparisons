...
/* This is functionally the same as useAgreementsRefdata in ui-agreements, because they share a module */
const useErmComparisonsRefdata = ({ desc, options = {}, returnQueryObject = false } = {}) => {
...
export default useErmComparisonsRefdata;
